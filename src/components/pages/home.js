...
import blogFeed from '../../static/blog-feed.xml?url';
        ...
        <div className="hero-stage">
          <div className="hero-top">
            ...
            <figure className="hero-portrait" data-hero-portrait>
              <img src={avatar} alt={siteConfig.fullName} />
            </figure>
          </div>
          ...
          <div className="hero-signature">
            ...
            <div className="hero-sig-left" data-hero-sig-left>
              <span className="byline">{siteConfig.fullName}</span>
            ...
            >
              {siteConfig.writing.subscribeLabel}
            </a>
          </div>
        </div>
      </div>
